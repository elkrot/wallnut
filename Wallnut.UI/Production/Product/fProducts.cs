...
using Wallnut.UI.Production.ProductListPriceHistory;
using Wallnut.UI.Production.ProductCostHistory;
...
namespace Wallnut.UI
{
    public partial class fProducts : Form
    {
         ...
         private void RemoveProduct()
        {
         ...
         {
             var frm = new fProductListPriceHistory();
             frm.productID = (dgvProducts.SelectedRows[0].DataBoundItem as Product).ProductID;
             frm.ShowDialog();
         }

         private void tsbProductCostHistory_Click(object sender, EventArgs e)
         {
             var frm = new fProductCostHistory();
             frm.productID = (dgvProducts.SelectedRows[0].DataBoundItem as Product).ProductID;
             frm.ShowDialog();
         }
