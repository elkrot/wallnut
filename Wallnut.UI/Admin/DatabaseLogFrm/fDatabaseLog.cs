...
{
    public partial class fDatabaseLog : Wallnut.UI.Implementations.ListForm
    {
        public ListFormBehavior<DatabaseLog, AddForm> behavior;
        public fDatabaseLog()
        {
            behavior = new ListFormBehavior<DatabaseLog, AddForm>(x => true, Reread);
            InitializeComponent();
        }
        public void Reread()
        {
